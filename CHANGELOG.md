...
## [v2.2.6](https://github.com/kubeflow/trainer/releases/tag/v2.2.6) (2026-05-11)

This is Kubeflow Trainer v2.2.6 release.

```bash
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/manager?ref=v2.2.6"
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/runtimes?ref=v2.2.6"
```

You can now install controller manager with Helm charts 🚀

```bash
helm install kubeflow-trainer oci://ghcr.io/kubeflow/charts/kubeflow-trainer --version 2.2.6
```

For more information, please see [the Kubeflow Trainer docs](https://www.kubeflow.org/docs/components/trainer/overview/)
### 🚀 Features

- feat(docs): Kubeflow Trainer ROADMAP 2026 ([#3242](https://github.com/kubeflow/trainer/pull/3242) by @Andrey Velichkevich)
- feat: add e2e tests to Helm CI workflow ([#3253](https://github.com/kubeflow/trainer/pull/3253) by @Sameer_Yadav)
- feat(docs): Add Kubeflow Trainer v2.2 release announcement to README ([#3435](https://github.com/kubeflow/trainer/pull/3435) by @Andrey Velichkevich)
- feat: add Megatron-Core GPT Tensor Parallelism example notebook ([#3201](https://github.com/kubeflow/trainer/pull/3201) by @Yash Agarwal)
- feat: customize R generation to include GPUs ([#3325](https://github.com/kubeflow/trainer/pull/3325) by @Vanessa Sochat)
- feat(docs): Changelog for Kubeflow Trainer v2.2.0 ([#3369](https://github.com/kubeflow/trainer/pull/3369) by @Andrey Velichkevich)
- feat(api): Set RuntimePatch.Time field automatically during admission ([#3319](https://github.com/kubeflow/trainer/pull/3319) by @Antonin Stefanutti)
- feat: add support for tracking TrainJob progress and training metrics ([#3227](https://github.com/kubeflow/trainer/pull/3227) by @Rob Bell)
- feat: add activeDeadlineSeconds ([#3258](https://github.com/kubeflow/trainer/pull/3258) by @Yash Agarwal)
- feat(api): Replace PodTemplateOverrides with RuntimePatches API  ([#3309](https://github.com/kubeflow/trainer/pull/3309) by @Antonin Stefanutti)
- feat(runtimes): Add XGBoost runtime(KEP-2598) ([#3200](https://github.com/kubeflow/trainer/pull/3200) by @Krishna Gupta)
- feat: support for flux framework as hpc manager ([#3188](https://github.com/kubeflow/trainer/pull/3188) by @Vanessa Sochat)
...
- feat(api): BREAKING CHANGE: Remove numProcPerNode from Torch API ([#3239](https://github.com/kubeflow/trainer/pull/3239) by @Andrey Velichkevich)

### 🐛 Bug Fixes

- fix(examples): unblock Megatron TP notebook on GPU E2E ([#3434](https://github.com/kubeflow/trainer/pull/3434) by @Yash Agarwal)
- fix(ci): Bump Python to 3.12 in E2Es ([#3330](https://github.com/kubeflow/trainer/pull/3330) by @Andrey Velichkevich)
...
- fix(ci): re-enable XGBoost E2E test ([#3323](https://github.com/kubeflow/trainer/pull/3323) by @Krishna Gupta)
- fix(examples): Verify TrainJob Completion ([#3331](https://github.com/kubeflow/trainer/pull/3331) by @Andrey Velichkevich)
- fix(docs): Update steps in release document ([#3335](https://github.com/kubeflow/trainer/pull/3335) by @Andrey Velichkevich)
- fix: back to a10-1 for gpu e2e and time slicing ([#3322](https://github.com/kubeflow/trainer/pull/3322) by @Akash Jaiswal)
- fix(ci): Generate valid release version for Python package ([#3333](https://github.com/kubeflow/trainer/pull/3333) by @Andrey Velichkevich)
- fix: rename JAX and Torch runtime plugin tests to descriptive names ([#3283](https://github.com/kubeflow/trainer/pull/3283) by @Amir Ibrahim)
...
- chore: Remove Year from copyright  ([#3276](https://github.com/kubeflow/trainer/pull/3276) by @Surya Sameer Datta Vaddadi)
- chore(examples): Use QuantileDMatrix for histogram tree method in XGBoost example ([#3376](https://github.com/kubeflow/trainer/pull/3376) by @Suyash Nalawade)
- chore: added docs for cncf gpu arc ([#3218](https://github.com/kubeflow/trainer/pull/3218) by @Akash Jaiswal)
...
- chore(ci): Remove Trivy Action ([#3389](https://github.com/kubeflow/trainer/pull/3389) by @Andrey Velichkevich)
- chore(runtimes): persist runtimes map and expose Runtimes function ([#3360](https://github.com/kubeflow/trainer/pull/3360) by @Tomas Tormo)
...
- chore: add timeout-minutes to gpu-e2e-test workflow ([#3329](https://github.com/kubeflow/trainer/pull/3329) by @Sameer_Yadav)
...
- chore(deps): Bump Torch to 2.10 version ([#3320](https://github.com/kubeflow/trainer/pull/3320) by @Andrey Velichkevich)
...
- chore: Remove deprecated Python models ([#3318](https://github.com/kubeflow/trainer/pull/3318) by @Andrey Velichkevich)
...
- chore(deps): Bump Trivy version to v0.69.2 ([#3265](https://github.com/kubeflow/trainer/pull/3265) by @Andrey Velichkevich)
